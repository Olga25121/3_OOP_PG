package HW.hw_6_rightDecision;

import HW.hw_6_rightDecision.Model.PrintedBook;
import HW.hw_6_rightDecision.Model.PrintedProduct;
import HW.hw_6_rightDecision.View.PrintProductView;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PrintedProduct<?> book3 = new PrintedBook("Булгаков", "Мастер и Маргарита", null, null, 123458, "книга", 1003);
        PrintedProduct<?> book4 = new PrintedBook("Булгаков", "Собачье сердце", null, null, 123459, "книга", 1004);
